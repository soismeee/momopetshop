                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="flex-grow-1 ms-3 overflow-hidden">
                                                                    <h5 class="mb-1 text-truncate">
                                                                        <a href="" class="font-size-15 text-dark">{{ $item->gambar_hewan }}</a>
                                                                    </h5>
                                                                    <p class="text-muted fw-semibold mb-0 text-truncate"> Stok {{ $item->jumlah_hewan }}</p>
                                                                </div>
                                                                <div class="flex-shrink-0 text-end ms-3">
                                                                    <h5 class="mb-1"><a href="/login" class="font-size-15 text-dark">Rp. {{ number_format($item->harga_hewan, 0,',','.') }}</a></h5>
