                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-5">
                                            <div class="popular-product-img p-2">
                                                <img src="/Gambar_upload/barang/{{ $barang[0]->gambar_barang }}" alt="">
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <span class="badge badge-soft-primary font-size-10 text-uppercase ls-05">
                                                {{ $barang[0]->kategori_barang->nama_kategori }}</span>
                                            <h5 class="mt-2 font-size-16"><a href="" class="text-dark">{{ $barang[0]->nama_barang }}</a>
                                            </h5>
                                            ...
                                            <div class="row g-0 mt-3 pt-1 align-items-end">
                                                ...
                                                <div class="col-4">
                                                    <div class="mt-1">
                                                        <h4 class="font-size-16">Rp. {{ number_format($barang[0]->harga_barang, 0,',','.') }}</h4>
                                                                        ...
                                                                        <div class="flex-shrink-0">
                                                                            <div class="avatar-md">
                                                                                <div class="product-img avatar-title img-thumbnail bg-soft-primary border-0">
                                                                                    <img src="/Gambar_upload/barang/{{ $item->gambar_barang }}" class="img-fluid" alt="">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="flex-grow-1 ms-3 overflow-hidden">
                                                                            <h5 class="mb-1 text-truncate">
                                                                                <a href="" class="font-size-15 text-dark">{{ $item->nama_barang }}</a>
                                                                            </h5>
                                                                            <p class="text-muted fw-semibold mb-0 text-truncate"> Stok {{ $item->stok_barang }}</p>
                                                                        </div>
                                                                        <div class="flex-shrink-0 text-end ms-3">
                                                                            <h5 class="mb-1"><a href="/login" class="font-size-15 text-dark">Rp. {{ number_format($item->harga_barang, 0,',','.') }}</a></h5>
                                                    ...
                                                    <div class="simplebar-content-wrapper"
                                                        ...
                                                        <div class="simplebar-content" style="padding: 0px 24px;">
                                                            ...
                                                            <div class="border-bottom loyal-customers-box pt-2">
                                                                <div class="d-flex align-items-center">
                                                                    <img src="/Gambar_upload/barang/{{ $bs->gambar_barang }}" class="rounded-circle avatar img-thumbnail" alt="{{ $bs->nama_barang }}">
                                                                    <div class="flex-grow-1 ms-3 overflow-hidden">
                                                                        <h5 class="font-size-15 mb-1 text-truncate">{{ $bs->nama_barang }}</h5>
                                                                        <p class="text-muted text-truncate mb-0">Rp. {{ number_format($bs->harga_barang,0,',','.') }}</p>
                                                                    </div>
                                                                    <div class="flex-shrink-0">
                                                                        <h5 class="font-size-14 mb-0 text-truncate w-xs bg-light p-2 rounded text-center"> {{ $bs->stok_barang }}</h5>
                                                                    </div>
                                                                </div>
                                                            </div>
