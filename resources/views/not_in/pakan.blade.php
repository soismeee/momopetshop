                                                    ...
                                                    <div class="col-xl-4 col-sm-6">
                                                        <div class="product-box rounded p-3 mt-4">
                                                            <div class="product-img bg-light p-3 rounded">
                                                                <img src="/Gambar_upload/barang/{{ $alat->gambar_barang }}"
                                                                    alt="" class="img-fluid mx-auto d-block">
                                                            </div>
                                                            <div class="product-content pt-3">
                                                                <p class="text-muted font-size-13 mb-0">
                                                                    {{ $alat->kategori_barang->nama_kategori }}</p>
                                                                <h5 class="mt-1 mb-0"><a href="#"
                                                                        class="text-dark font-size-16">{{ $alat->nama_barang }}</a>
                                                                </h5>
                                                                <a href="/login" class="product-buy-icon bg-primary"
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    title="" data-bs-original-title="Add To Cart">
                                                                    <i
                                                                        class="mdi mdi-cart-outline text-white font-size-16"></i>
                                                                </a>
                                                                <h5 class="font-size-20 text-primary mt-3 mb-0">Rp.
                                                                    {{ number_format($alat->harga_barang, 0, ',', '.') }} </h5>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
