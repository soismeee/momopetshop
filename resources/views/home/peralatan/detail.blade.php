                            ...
                            <div class="row">
                                                ...
                                                <div class="swiper-slide rounded swiper-slide-active" role="group" aria-label="1 / 5" style="width: 354px; margin-right: 24px;">
                                                   <div class="p-3">
                                                        <div class="product-img bg-light rounded p-3">
                                                            <img src="/Gambar_upload/barang/{{ $peralatan->gambar_barang }}" class="img-fluid d-block">
                                                        </div>
                                                   </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-xl-8">
                                    <div class="mt-3 mt-xl-3 ps-xl-5">
                                        <h4 class="font-size-20 mb-3"><a href="" class="text-dark">{{ $peralatan->nama_barang }}</a></h4>

                                        <div class="text-muted mt-2">
                                            <span class="badge bg-success font-size-14 me-1"> <i class="mdi mdi-star"></i> {{ $peralatan->kategori }}</span>
                                        </div>

                                        <h2 class="text-primary mt-4 py-2 mb-0">Rp. {{ number_format($peralatan->harga_barang,0,',','.') }}</h2>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mt-3">
                                                        ...
                                                        <p>{{ $peralatan->keterangan_barang }}</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mt-3">
                                                        ...
                                                        <p>{{ $peralatan->stok_barang }} Barang</p>
                                                    </div>
                                                </div>
                                            </div>
