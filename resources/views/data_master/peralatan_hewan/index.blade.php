            ...
            <div class="col-xl-12">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title mb-0">Form input peralatan hewan</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select name="kph_id" id="kph_id" class="form-select">
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                <label for="formrow-password-input" class="form-label">Harga Beli</label>
                                                <input type="text" class="form-control input" placeholder="Masukan harga beli" id="harga_beli" name="harga_beli">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Peralatan Hewan</h4>
                                <p class="card-title-desc">Data peralatan hewan.</p>
                            </div>
                            <div class="card-body">
